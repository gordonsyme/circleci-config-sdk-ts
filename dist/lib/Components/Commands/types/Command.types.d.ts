 ...
 */
export type NativeCommandLiteral = 'restore_cache' | 'save_cache' | 'attach_workspace' | 'persist_to_workspace' | 'add_ssh_keys' | 'checkout' | 'run' | 'setup_remote_docker' | 'store_artifacts' | 'store_test_results';
