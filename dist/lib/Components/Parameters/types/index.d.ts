 ...
 */
export type AnyParameterType = EnumParameter | StringParameter | BooleanParameter | IntegerParameter | StepsParameter | ExecutorParameter | EnvironmentParameter | MatrixParameter | FilterParameter;
...
export type CustomEnumParameterContentsShape = CustomParameterContentsShape<EnumParameterLiteral> & {
    enum: string[];
};
