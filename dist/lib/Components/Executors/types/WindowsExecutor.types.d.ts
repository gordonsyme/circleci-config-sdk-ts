 ...
 */
export type WindowsResourceClass = Extract<AnyResourceClass, 'medium' | 'large' | 'xlarge' | '2xlarge'>;
/**
 * Completed resource class after generation, including the windows prefix.
 */
export type WindowsResourceClassGenerated = 'windows.medium' | 'windows.large' | 'windows.xlarge' | 'windows.2xlarge';
