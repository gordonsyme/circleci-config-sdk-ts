 ...
 */
export type MachineResourceClassArm = 'arm.medium' | 'arm.large' | 'arm.xlarge' | 'arm.2xlarge';
/**
 ...
 */
export type MachineResourceClassGPU = 'gpu.nvidia.small' | 'gpu.nvidia.medium' | 'gpu.nvidia.large';
/**
 ...
 */
export type MachineResourceClass = Extract<AnyResourceClass, 'medium' | 'large' | 'xlarge' | '2xlarge' | MachineResourceClassArm | MachineResourceClassGPU>;
