 ...
 */
export type MacOSResourceClass = Extract<AnyResourceClass, 'medium' | 'large' | MacOSResourceClassAdvanced>;
export type MacOSResourceClassAdvanced = 'macos.x86.metal.gen1' | 'macos.x86.medium.gen2';
